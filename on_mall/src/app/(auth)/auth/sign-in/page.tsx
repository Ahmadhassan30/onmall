        ...
        <div className="hidden lg:block space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900 leading-tight">
              Welcome Back to OnMall
            </h1>
            <p className="text-xl text-gray-600">
              Your favorite multi-vendor marketplace for everything you need
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Protected payments and buyer guarantee</p>
              </div>
            </div>
          ...
          <Card className="border-0 shadow-xl">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center text-sm text-gray-600">
                ...
                <Link href="/auth/sign-up" className="text-orange-600 hover:text-orange-500 font-medium">
                  Sign up for free
                </Link>
              </div>
            </CardContent>
